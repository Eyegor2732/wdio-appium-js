...
// Calculate cores (fallback for older Node versions)
...
export const config = {
    ...
    //
    // Keep base config platform-neutral; platform configs set device-specific limits.
    maxInstances: isCI ? 1 : Math.max(1, cpuCores - 1),
    //
    ...
    specFileRetriesDelay: isCI ? 10 : 0,
    //
